...
import com.example.android.schoolfinder.schoolOwners.Adapters.AuthViewPagerAdapter;
...
public class AuthenticationViewPagerActivity extends AppCompatActivity implements AuthenticationViewPagerCallbacks {
            ...
            dbRef
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            intent.putExtra(BundleConstants.USER_BUNDLE, (Users) dataSnapshot.getValue());
    ...
    public void nextButtonCLicked(Users users) {
        authenticationBinding.authViewPager.setCurrentItem(3);
        Fragment fragment = getSupportFragmentManager().findFragmentByTag(
                makeFragmentName(R.id.auth_view_pager, authenticationBinding.authViewPager.getCurrentItem()));
        Log.e(TAG, "Adapter Current position " + authenticationBinding.authViewPager.getCurrentItem());

        if (3 == authenticationBinding.authViewPager.getCurrentItem() && null != fragment) {
            Log.e(TAG, "Fragment not null oooh");
            ((SchoolSignUpFragment) fragment).setSchoolOwnerDetails(users);
        } else {
            Log.e(TAG, "Fragment IS null oooh and the id is ");
        }
    }
