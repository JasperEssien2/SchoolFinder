 ...
 */
public class SearchPageFragment extends Fragment implements OnCountrySelected,
    ...
    SearchStackedCardAdapter cardAdapter;
...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        searchBinding = DataBindingUtil.inflate(inflater, R.layout.activity_search, container, false);
        cardAdapter = new SearchStackedCardAdapter(getActivity(), new ArrayList<School>(),
                transactionsAction, searchSchoolViewModels);
        searchSchoolViewModels = new ViewModelProvider.AndroidViewModelFactory(getActivity().getApplication())
        ...
        ((HomeActivity) getActivity()).initToolbar(searchBinding.toolbar);
